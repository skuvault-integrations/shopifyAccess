...
namespace ShopifyAccessTests.GraphQl.Models.ProductVariantsInventoryReport.Extensions
{
	...
	public class ProductVariantsInventoryReportParserTests
	{
		private const string Response =
			...
			{""quantities"":[{""quantity"":10}],""location"":{""id"":""gid://shopify/Location/43176333"",""name"":""10107 Production Court""},""__parentId"":""gid://shopify/ProductVariant/337095344""}
			{""quantities"":[{""quantity"":20}],""location"":{""id"":""gid://shopify/Location/1836161"",""name"":""10107 Production Ct.""},""__parentId"":""gid://shopify/ProductVariant/337095344""}
			{""id"":""gid://shopify/ProductVariant/337095346"",""sku"":""testsku2"",""inventoryItem"":{""id"":""gid://shopify/InventoryItem/2860696961"",""tracked"":false}}
			{""quantities"":[{""quantity"":30}],""location"":{""id"":""gid://shopify/Location/17468227646"",""name"":""Is This a POS Location""},""__parentId"":""gid://shopify/ProductVariant/337095346""}
			{""quantities"":[{""quantity"":40}],""location"":{""id"":""gid://shopify/Location/36696031294"",""name"":""TestLocation""},""__parentId"":""gid://shopify/ProductVariant/337095346""}";
		...
		public void Parse_ReturnsListOfProductVariants_WhenStreamProvided()
		{
			...
			productVariants[ 0 ].InventoryItem.InventoryLevelsNodes.Nodes[ 0 ].Quantities.First().Quantity.Should().Be( 10 );
			productVariants[ 0 ].InventoryItem.InventoryLevelsNodes.Nodes[ 0 ].Location.LocationId.Should().Be( "gid://shopify/Location/43176333" );
			productVariants[ 0 ].InventoryItem.InventoryLevelsNodes.Nodes[ 1 ].Quantities.First().Quantity.Should().Be( 20 );
			...
			productVariants[ 1 ].InventoryItem.InventoryLevelsNodes.Nodes[ 0 ].Quantities.First().Quantity.Should().Be( 30 );
			...
			productVariants[ 1 ].InventoryItem.InventoryLevelsNodes.Nodes[ 1 ].Quantities.First().Quantity.Should().Be( 40 );
