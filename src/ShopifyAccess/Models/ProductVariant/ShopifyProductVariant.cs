...
namespace ShopifyAccess.Models.ProductVariant
{
	...
	public class ShopifyProductVariant: IEquatable< ShopifyProductVariant >
	{
		...
		{
			return this.Id.Equals( other.Id ) && this.Quantity.Equals( other.Quantity ) && this.InventoryManagement.Equals( other.InventoryManagement ) && string.Equals( this.Sku, other.Sku );
		}
